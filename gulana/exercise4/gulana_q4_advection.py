# -*- coding: utf-8 -*-
"""
Created on Fri Oct 18 16:47:10 2024
...
def q4(dt):
    ...
    plt.title(f"Linear advection diffusion equation (explicit scheme) dt = {dt}")
    plt.xlabel('x')
    plt.ylabel('U')
    plt.legend()
    plt.savefig(f"gulana_q4_advection_diffusion.jpeg")
