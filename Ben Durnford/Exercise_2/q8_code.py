...
ax1.plot(Ls*Xce,H0s*(H0-Hxt),'k',lw=2) #, color[int(i-1)],label = f' $\eta_n: t = {t:.3f}$')
ax1.plot( Ls*Xce,H0s*( H0+Ad*(H0/Hxt)**0.25 ),'--r',lw=1 ) # asymptotics 
...
fig.savefig('q8_shallow_topog.png')
